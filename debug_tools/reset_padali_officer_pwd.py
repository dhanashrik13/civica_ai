...
def reset_officer_pwd():
    print(f"Starting reset for {username}...")
    ...
    profile.save()
    print("| OfficerProfile Sync | ✅ COMPLETED |")
    ...
    # Officer Portal Auth
    # authenticate_for_role uses email, so we need the user's email
    email = user.email
